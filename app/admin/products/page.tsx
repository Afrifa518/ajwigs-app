                  ...
                  <div key={p._id} className="px-5 py-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex min-w-0 items-center gap-3">
                        <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-lg border border-slate-800 bg-slate-900/40">
                          {p.image?.[0] ? (
                            <Image
                              src={p.image[0]}
                              alt={p.name}
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="truncate text-xs text-slate-500">{p.category} / {p.subCategory}</p>
                          <p className="truncate text-xs text-slate-600">{p._id}</p>
                        </div>
                      </div>
                      <p className="shrink-0 text-sm text-slate-200">{formatMoney(p.price)}</p>
                    </div>
                    ...
                    <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
                      ...
                      <button
                        className="inline-flex items-center justify-center rounded-xl border border-slate-800 bg-slate-900/40 px-3 py-2 text-xs font-medium text-rose-100 hover:bg-slate-900/70"
                        type="button"
