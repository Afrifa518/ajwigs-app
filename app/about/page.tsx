    ...
    <div>
      ...
      <div className=" my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>
            ...
            combine comfort and versatility with cutting-edge style.
          </p>
          <b className="text-gray-800">Our Mission</b>
          <p>
            Our mission is to offer individuals the opportunity to express their personal
            style through high-quality wigs that blend fashion with function. We strive to
            build confidence in every customer by delivering products that are not only
            beautiful but also comfortable and versatile for everyday wear or special
            occasions.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20">
        ...
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Convenience</b>
          <p className="text-gray-600">
            We make shopping easy and stress-free. With our user-friendly online store, you
            can browse our wide selection of wigs, place your order, and have it delivered
            to your doorstep—no hassle, just beautiful wigs at your convenience.
          </p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Exceptional Customer Service</b>
          <p className="text-gray-600">
            Our team is dedicated to ensuring that every customer feels valued. Whether you
            need help choosing the right wig, have questions about care, or need support
            after your purchase, we’re here to assist you at every step of the way. Your
